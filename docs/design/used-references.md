...
[SQLAlchemy](https://www.sqlalchemy.org) is another tool I never used before. Its own [documentation](https://docs.sqlalchemy.org/en/20/orm/index.html) was sufficient for my usage.
